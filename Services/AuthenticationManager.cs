...
namespace Services
{
    public class AuthenticationManager : IAuthenticationService
    {
        ...
        {
            var signInCreadentials = GetSignInCreadentials();
            var claims = await GetClaims();
            var tokenOptions = GenerateTokenOptions(signInCreadentials, claims);
        ...
        private SigningCredentials GetSignInCreadentials()
        {
        ...
        private JwtSecurityToken GenerateTokenOptions(SigningCredentials signInCreadentials, List<Claim> claims)
        {
            var jwtSettings = _configuration.GetSection("JwtSettings");
